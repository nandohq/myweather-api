/* POPULANDO PAÍSES */
INSERT INTO mw_pais (pai_id, pai_nome, pai_sigla_2, pai_sigla_3) VALUES
...
INSERT INTO mw_cidade (cid_id, cid_nome, cid_descricao, cid_longitude, cid_latitude, cid_pais) VALUES
(3447839, "Senhor do Bonfim", "A Capital Baiana do Forró é também o princípio das artes cênicas no sertão do estado. Terra de poetas, filarmônicas, quilombolas e... São João!", -40.189442, -10.46139, 76),
(3450554, "Salvador", "A primeira capital do Brasil se divide em Cidade Alta e Cidade Baixa, mas a segregação para aí: sua gente é muito acolhedora num verão eterno", -38.51083, -12.97111, 76),
(3460548, "Itiúba", "A Laje do Céu é um dos pontos mais altos do estado da Bahia, numa cidade de povo valente e batalhador. Lampião preferiu dar a volta ao fugir de um cerco na vizinha Queimadas", -39.853611, -10.69167, 76),
(3463478, "Feira de Santana", "A Princesinha do Sertão não gosta muito de castelos e prefere a forja do trabalho. Produz o que a Bahia precisar e é passagem obrigatória para qualquer lugar da Terra de Jorge Amado", -38.966671, -12.26667, 76),
(3468031, "Camaçari", "Maior polo industrial da América Latina, se divide entre o trabalho fabril e comercial e o mergulho nas belas praias da sua orla", -38.324169, -12.6975, 76);
